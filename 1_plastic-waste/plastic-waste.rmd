...
plastic_waste %>% 
  ggplot(aes(x = plastic_waste_per_cap, group = continent, fill = continent)) +
...
plastic_waste %>% 
  ggplot(aes(x = plastic_waste_per_cap, y = mismanaged_plastic_waste_per_cap, colour = continent)) +
  geom_jitter() +
  theme_bw()
```
